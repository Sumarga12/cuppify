...
_initLoginDependencies() async {
  ...
  getIt.registerFactory<LoginBloc>(
    () => LoginBloc(
      homeCubit: getIt<HomeCubit>(), loginUsecase: getIt<LoginUsecase>(),
    ),
  );
}
...
_initProfileDependencies() async {
  getIt.registerFactory<ProfileRemoteDatasource>(() => ProfileRemoteDatasourceImpl( dio: getIt<Dio>(), tokenSharedPrefs: getIt<TokenSharedPrefs>()));
